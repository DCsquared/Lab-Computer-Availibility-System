...
namespace LabAssignment1_CSC340
{
    public partial class Lab430 : Form
    {
        ...
        public Lab430()
        {
            ...
            //label3.Text += "Equipments: " + labList[0].equipMents;
            //date time test
        ...
        private void collectButtons()
        {
            ...
            //label3.Text = "Available Computers: " + ava.ToString();
        }
        ...
        public void collectButtons2()
        {
            ...
            label3.Text = "Available Computers: " + (maxava-ava) + "  Equipments: " + labList[0].equipMents;
        }

        private static void button_Click(object sender, EventArgs e)
        {
            Button b = (Button)sender;
            if (b.BackColor == Color.Red && b.Text != "Refresh" && b.Text != "Simulate login" && b.Text != "SImulate log out" && b.Text != "Random login" && b.Text != "Random log out" && b.Text != "Return to Main Menu")
            {
                b.BackColor = Color.LimeGreen;
                int bb = Convert.ToInt32(b.Text);
                Lab.getlabComputerStatus(bb, 0, 1);

            }
            else if (b.BackColor == Color.LimeGreen && b.Text != "Refresh" && b.Text != "Simulate login" && b.Text != "SImulate log out" && b.Text != "Random login" && b.Text != "Random log out" && b.Text != "Return to Main Menu")
            {
                b.BackColor = Color.Red;
                int bb = Convert.ToInt32(b.Text);
                Lab.getlabComputerStatus(bb, 1, 1);
        ...
        private void Lab430_Load(object sender, EventArgs e)
        {
